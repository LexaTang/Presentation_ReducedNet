...
\input{Tex/Preamble_Fonts_Charter_FiraSans}
...
\input{Tex/Preamble_Sansserif_math}
...
\@ifclasswith{beamer}{aspectratio=43}{%
	...
	\setbeamerfont{title}
		{parent=structure, size*={14}{20}}
	\setbeamerfont{subtitle}
		{parent=structure, size*={13}{20}}
	\setbeamerfont{frametitle}
...
% Put border around blokc, exampleblock, and alertblock
% ==>
...
\newcommand{\PutBorderAroundBlock}[2]{
	...
	\addtobeamertemplate{\blocktype begin}{%
		\begin{mdframed}[linecolor=#2, linewidth=0.35pt, leftmargin=0pt, innerleftmargin=0.39em, innerrightmargin=0.39em, innertopmargin=-0.01ex, innerbottommargin=5pt]%
...
\PutBorderAroundBlock{}{SpotColor}
\PutBorderAroundBlock{example}{ExampleColor}
\PutBorderAroundBlock{alerted}{AlertColor}
...
\setbeamertemplate{proof begin}{%
	...
	\usebeamercolor[fg]{theorem title}%
	证明(\insertproofname)\\[\smallskipamount]
...
\usepackage[center, small, bf, labelsep=period]{caption}
%\captionsetup{%
%	figurename=图,
%	tablename=表
%}
...
\input{Tex/Preamble_BibLaTeX_AER}
